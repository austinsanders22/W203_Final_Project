...
#Model 1: Rating Only
# Base Case - R Movies
model_1 = lm(log(gross) ~ PG13, data = df)

#Model 2: Rating and Quality
# Base Case - R Movies with rating of 0
model_2 = lm(log(gross) ~ PG13 + score, data = df)

#Model 3: Rating and Quality with interaction terms
model_3 = lm(log(gross) ~ PG13 + score + PG13*score, data = df)

#Model 4: Rating and Quality with budget
model_4 = lm(log(gross) ~ PG13 + score + log(budget), data = df)

#Model 5: Rating and Quality with budget and interaction terms
model_5 = lm(log(gross) ~ PG13 + score + PG13 * score + log(budget) + log(budget) * PG13, data = df)
